(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_b638c03f._.js", {
...
__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].defaults.baseURL = ("TURBOPACK compile-time value", "http://localhost:3001/api");
...
const useFollows = ()=>{
    ...
    // Fetch followers
    const { data: followers, isLoading: isLoadingFollowers } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'followers'
        ],
        queryFn: {
            "useFollows.useQuery": async ()=>{
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/follows');
                return response.data.data;
            }
        }["useFollows.useQuery"]
    });
    // Fetch following
    const { data: following, isLoading: isLoadingFollowing } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'following'
        ],
        queryFn: {
            "useFollows.useQuery": async ()=>{
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/follows/following');
                return response.data.data;
            }
        }["useFollows.useQuery"]
    });
    // Fetch suggestions
    const { data: suggestions, isLoading: isLoadingSuggestions, refetch: refetchSuggestions } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'suggestions'
        ],
        queryFn: {
            "useFollows.useQuery": async ()=>{
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/follows/suggestions');
                return response.data.data;
            }
        }["useFollows.useQuery"]
    });
    ...
    const followMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "useFollows.useMutation[followMutation]": async (userId)=>{
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`/follows/follow/${userId}`);
                return response.data;
            }
        }["useFollows.useMutation[followMutation]"],
        onSuccess: {
            "useFollows.useMutation[followMutation]": ()=>{
    ...
    const unfollowMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "useFollows.useMutation[unfollowMutation]": async (userId)=>{
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/follows/unfollow/${userId}`);
                return response.data;
            }
        }["useFollows.useMutation[unfollowMutation]"],
        onSuccess: {
            "useFollows.useMutation[unfollowMutation]": ()=>{
                queryClient.invalidateQueries({
                    queryKey: [
...
_s(useFollows, "NjXZmVGkPQ2UkPN6zZV+TrfSrqE=", false, function() {
    return [
...
//# sourceMappingURL=src_b638c03f._.js.map