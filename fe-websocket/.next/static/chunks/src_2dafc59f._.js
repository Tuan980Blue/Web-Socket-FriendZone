(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_2dafc59f._.js", {
...
const useNotifications = ()=>{
    ...
    const fetchNotifications = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useNotifications.useCallback[fetchNotifications]": async ()=>{
            if (notifications.length === 0) {
                setIsLoading(true);
                try {
                    const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$notificationService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["notificationService"].getNotifications();
    ...
    const handleMarkAsRead = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useNotifications.useCallback[handleMarkAsRead]": async (notificationId)=>{
            try {
                // Optimistic update
                setNotifications({
                    "useNotifications.useCallback[handleMarkAsRead]": (prev)=>prev.map({
                            "useNotifications.useCallback[handleMarkAsRead]": (notification)=>notification.id === notificationId ? {
                                    ...notification,
                                    read: true
                                } : notification
                        }["useNotifications.useCallback[handleMarkAsRead]"])
                }["useNotifications.useCallback[handleMarkAsRead]"]);
                setUnreadCount({
                    "useNotifications.useCallback[handleMarkAsRead]": (prev)=>Math.max(0, prev - 1)
                }["useNotifications.useCallback[handleMarkAsRead]"]);
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$notificationService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["notificationService"].markAsRead(notificationId);
            } catch (error) {
    ...
    const handleMarkAllAsRead = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useNotifications.useCallback[handleMarkAllAsRead]": async ()=>{
            try {
                // Optimistic update
                setNotifications({
                    "useNotifications.useCallback[handleMarkAllAsRead]": (prev)=>prev.map({
                            "useNotifications.useCallback[handleMarkAllAsRead]": (notification)=>({
                                    ...notification,
                                    read: true
                                })
                        }["useNotifications.useCallback[handleMarkAllAsRead]"])
                }["useNotifications.useCallback[handleMarkAllAsRead]"]);
                setUnreadCount(0);
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$notificationService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["notificationService"].markAllAsRead();
            } catch (error) {
    ...
    const addNotification = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useNotifications.useCallback[addNotification]": (notification)=>{
            setNotifications({
            ...
            if (!notification.read) {
                setUnreadCount({
                    "useNotifications.useCallback[addNotification]": (prev)=>prev + 1
                }["useNotifications.useCallback[addNotification]"]);
            }
        }
    }["useNotifications.useCallback[addNotification]"], []);
...
_s(useNotifications, "oq67KsR2Be+0cRbMS/+10dMk6kg=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/app/(layout)/notifications/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    switch(type){
        case 'LIKE':
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tabler$2f$icons$2d$react$2f$dist$2f$esm$2f$icons$2f$IconHeart$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__IconHeart$3e$__["IconHeart"], {
                ...
                fileName: "[project]/src/app/(layout)/notifications/page.tsx",
                lineNumber: 36,
                columnNumber: 20
            }, this);
        case 'COMMENT':
...
const NotificationsPage = ()=>{
    _s();
    const { notifications, total, page, totalPages, unreadCount, isLoading, handleMarkAsRead, handlePageChange } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useNotifications$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotifications"])();
            ...
            isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(LoadingSkeleton, {}, void 0, false, {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$core$2f$esm$2f$components$2f$Stack$2f$Stack$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Stack"], {
                        ...
                        mb: "xl",
                        children: [
                            notifications.map((notification)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(NotificationCard, {
...
_s(NotificationsPage, "i05D68iZdXMHEe9hIChiNW7bmUw=", false, function() {
    return [
...
//# sourceMappingURL=src_2dafc59f._.js.map