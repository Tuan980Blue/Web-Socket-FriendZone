...
export default function RightSidebar() {
  return (
    <div className="fixed hidden lg:block right-0 top-16 max-w-72 h-[calc(100vh-4rem)] bg-[#FAFAFA] dark:bg-[#121212] border-l border-[#DBDBDB] dark:border-[#262626] p-4 overflow-y-auto">
