    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      <div className="flex space-x-6 overflow-x-auto scrollbar-hide">
        ...
        {stories.map((story) => (
          ...
          >
            <div className="relative w-14 h-14 rounded-full overflow-hidden border-2 border-blue-500 p-1">
              <Image
                src={story.image}
                alt={user.username}
                fill
        ...
        <motion.div
            ...
            className="flex flex-col items-center"
        >
          <div className="relative w-14 h-14 rounded-full overflow-hidden border-2 border-dashed border-gray-300 dark:border-gray-600 flex items-center justify-center">
