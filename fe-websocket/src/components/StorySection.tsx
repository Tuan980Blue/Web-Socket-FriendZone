                ...
                <div className="max-w-2xl mx-auto">
                    ...
                    {isLoading ? (
                        ...
                        <div className="flex space-x-4 overflow-x-auto scrollbar-hide px-4">
                            ...
                            >
                                <div
                                    className="relative w-16 h-16 rounded-full border-2 border-dashed border-gray-300 dark:border-gray-600 flex items-center justify-center bg-gray-50 dark:bg-gray-800">
                                    <div
                                        className="w-12 h-12 rounded-full bg-gradient-to-tr from-yellow-400 to-pink-600 flex items-center justify-center">
                                    ...
                                    <div key={firstStory.author.id} className="relative">
                                        ...
                                        >
                                            <div className={`relative w-16 h-16 rounded-full p-0.5 ${
                                                ...
                                                {group.length > 1 && (
                                                    <div
                                                        className="absolute -bottom-1 -right-1 bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-xs rounded-full w-5 h-5 flex items-center justify-center border border-gray-300 dark:border-gray-600">
                                                        {group.length}
                                                    </div>
                                                )}
                                                ...
                                                {isOwnStory && firstStory.story.viewCount > 0 && (
                                                    <div
                                                        className="absolute -bottom-1 -right-1 bg-blue-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center">
                                                        {firstStory.story.viewCount > 99 ? '99+' : firstStory.story.viewCount}
                                                    </div>
                                                )}
                                            </div>
                                            <span
                                                className="text-xs text-gray-600 dark:text-gray-400 truncate max-w-[60px]">
