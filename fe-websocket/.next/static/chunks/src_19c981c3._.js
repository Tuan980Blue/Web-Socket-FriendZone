(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_19c981c3._.js", {
...
const useNotifications = ()=>{
    ...
    const { data, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "useNotifications.useQuery": async ()=>{
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/notifications?page=${page}&limit=${limit}`);
    ...
    const markAsReadMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "useNotifications.useMutation[markAsReadMutation]": async (notificationId)=>{
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`/notifications/${notificationId}/read`);
    ...
    // Get unread count
    const { data: unreadCount } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'unreadCount'
        ],
        queryFn: {
            "useNotifications.useQuery": async ()=>{
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/notifications/unread/count');
...
_s(useNotifications, "WtflxttVk1lRhB6mGfgCea6sIew=", false, function() {
    return [
...
//# sourceMappingURL=src_19c981c3._.js.map